          ...
          <div className="flex flex-wrap gap-2 w-full md:w-auto">
            {user.created_at && (
              <div
                ...
                aria-label={`${t("user_since")} ${shortFormatDate(
                  user.created_at
                )}`}
              >
            ...
            {user.last_login && (
              <div
                ...
                aria-label={`${t("last_login_short")} ${shortFormatDate(
                  user.last_login
                )}`}
              >
            ...
            >
              ...
              <span className="text-green-700 text-xs">{t("active")}</span>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
            <div className="flex items-center gap-3">
              ...
              <h2
                ...
                aria-label={t("subscription_plan")}
              >
                {subscription.plan}
              </h2>
            </div>
            ...
            <div className="mt-2">
              <div className="flex justify-between items-center mb-1">
                <span className="text-xs font-medium">
                  {t("usage")}: {subscription.traffic_used.toLocaleString()}/
                  {subscription.traffic_limit.toLocaleString()} {t("hits")}
                </span>
                <span
