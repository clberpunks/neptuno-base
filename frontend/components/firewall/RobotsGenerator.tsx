...
export default function RobotsGenerator({ rules }: RobotsGeneratorProps) {
  ...
  return (
    <ExpandablePanel
      title={t("robots_generator")}
      description={t("robots_generator_description")}
      icon={
        <svg
