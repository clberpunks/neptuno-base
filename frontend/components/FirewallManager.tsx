...
export default function FirewallManager() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        <button
          className={`w-full p-6 text-left flex justify-between items-center hover:bg-gray-50 transition-colors ${
            firewallExpanded ? "bg-gray-50" : ""
          }`}
          onClick={() => setFirewallExpanded(!firewallExpanded)}
          aria-expanded={firewallExpanded}
          aria-label={
            firewallExpanded ? t("collapse_section") : t("expand_section")
          }
        >
          <div className="flex items-center">
            <div className="bg-green-500 w-10 h-10 rounded-lg flex items-center justify-center text-white mr-4">
              <svg
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800">
                {t("firewall_management")}
              </h2>
              <p className="text-gray-600 mt-1">{t("manage_access_rules")}</p>
            </div>
          </div>
          <div className="flex items-center">
            {rules.length > 0 && (
              <div className="bg-red-100 text-red-800 px-3 py-1 rounded-full text-sm font-medium mr-4">
                        ...
                        >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex flex-wrap gap-2">
                              {(["allow", "block", "restricted", "tariff"] as const).map(
                                (policy) => (
                                  <button
                                    key={policy}
                                  ...
                                  <div className="space-y-1">
                                    ...
                                    {r.policy === "tariff" && (
                                      <p>
                                        ...
                                        ${r.fee?.toFixed(2) ?? '0.00'} {t("per_request")}
                                      </p>
                                    )}
                                  </div>
                                </div>
      ...
      <RobotsGenerator
        rules={rules}
        isExpanded={robotsExpanded}
        toggleExpand={() => setRobotsExpanded(!robotsExpanded)}
      />
